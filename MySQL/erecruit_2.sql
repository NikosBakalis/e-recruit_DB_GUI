...
CONSTRAINT INTERVIEW_JOB_ID FOREIGN KEY (job_id) REFERENCES job(id) ON DELETE CASCADE ON UPDATE CASCADE
)engine=InnoDB;
...
insert into average_personality_score (recruiter_username, candidate_username, job_id, per_sc) values
('bettyg', 'cleogeo', '9', '1'),
('bettyg', 'cleogeo', '9', '5'),
('bettyg', 'lionarF', '9', '2')
;
