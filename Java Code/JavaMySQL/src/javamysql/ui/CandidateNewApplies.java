 ...
 * @author Nikolas
 */
public class CandidateNewApplies extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CandidateNewApplies.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CandidateNewApplies().setVisible(true);
            }
        });
    }
    
    public CandidateNewApplies getOpenAppliesNew(String username) {
        iCRUDImpl.openConnection();
        try{
            CandidateNewApplies getAppliesNew = new CandidateNewApplies();
    ...
    public CandidateNewApplies getAppliesNew(String username) {
        iCRUDImpl.openConnection();
        try{
            CandidateNewApplies getAppliesNew = new CandidateNewApplies();
            String query = "SELECT DISTINCT applies.job_ID, position FROM job INNER JOIN applies ON job.id = applies.job_id WHERE cand_usrname = '" + username + "' AND NOW() < job.submission_date";
    ...
    public CandidateNewApplies getCompletedAppliesNew(String username) {
        iCRUDImpl.openConnection();
        try{
            CandidateNewApplies getCompletedAppliesNew = new CandidateNewApplies();
            String query = "SELECT DISTINCT applies.job_ID, position FROM job INNER JOIN applies ON job.id = applies.job_id WHERE cand_usrname = '" + username + "' AND NOW() > job.submission_date";
            PreparedStatement preparedStatement = iCRUDImpl.getConnection().prepareStatement(query);
            ResultSet resultSet = preparedStatement.executeQuery();
            TableApplies.setModel(DbUtils.resultSetToTableModel(resultSet));
    ...
    public void setValueID(int valueID) {
        CandidateNewApplies.valueID = valueID;
    }
    ...
    public void setValueRecruiter(String valueRecruiter) {
        CandidateNewApplies.valueRecruiter = valueRecruiter;
    }
}
