 ...
 * @author Nikolas
 */
public class InterviewUI extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterviewUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterviewUI().setVisible(true);
            }
        });
    }
    
    public InterviewUI getMyInterviews(String recruiterUsername, int jobID) {
    ...
    public InterviewUI getNewInterviews(int jobID) {
        iCRUDImpl.openConnection();
        try{
            InterviewUI interviewUI = new InterviewUI();
    ...
    public void setValueRecruiterUsername(String valueRecruiterUsername) {
        InterviewUI.valueRecruiterUsername = valueRecruiterUsername;
    }
    ...
    public void setValueCandidateUsername(String valueCandidateUsername) {
        InterviewUI.valueCandidateUsername = valueCandidateUsername;
    }
    ...
    public void setValueJobID(int valueJobID) {
        InterviewUI.valueJobID = valueJobID;
    }
