 ...
 * @author Nikolas
 */
public class InterviewStart extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        changePersonalityScore.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2", "3", "4", "5" }));

        EducationScore.setText("Education Score");

        changeEducationScore.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2", "3", "4", "5" }));

        changeExperienceScore.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2", "3", "4", "5" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterviewStart.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterviewStart().setVisible(true);
            }
        });
    }
    ...
    public void setNewRecruiterUsername(String newRecruiterUsername) {
        InterviewStart.newRecruiterUsername = newRecruiterUsername;
    }
    ...
    public void setNewCandidateUsername(String newCandidateUsername) {
        InterviewStart.newCandidateUsername = newCandidateUsername;
    }
    ...
    public void setNewComments(String newComments) {
        InterviewStart.newComments = newComments;
    }
    ...
    public void setNewJobID(int newJobID) {
        InterviewStart.newJobID = newJobID;
    }
    ...
    public void setNewPersonalityScore(int newPersonalityScore) {
        InterviewStart.newPersonalityScore = newPersonalityScore;
    }
    ...
    public void setNewEducationScore(int newEducationScore) {
        InterviewStart.newEducationScore = newEducationScore;
    }
    ...
    public void setNewExperienceScore(int newExperienceScore) {
        InterviewStart.newExperienceScore = newExperienceScore;
    }
    ...
    public void setNewInterviewDate(Date newInterviewDate) {
        InterviewStart.newInterviewDate = newInterviewDate;
    }
    ...
    public void setNewStartingTime(Time newStartingTime) {
        InterviewStart.newStartingTime = newStartingTime;
    }
    ...
    public void setNewEndingTime(Date newEndingTime) {
        InterviewStart.newEndingTime = newEndingTime;
    }
    ...
    public void setNewDuration(Time newDuration) {
        InterviewStart.newDuration = newDuration;
    }
